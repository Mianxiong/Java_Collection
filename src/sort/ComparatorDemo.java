...
public class ComparatorDemo {
    ...
    public static void main(String[] args) {
        ...
        students[0] = new Student(1,"aiaofang", 90);
        students[1] = new Student(2,"xiaofang", 80);
        students[2] = new Student(3,"biaofang", 90);
        students[3] = new Student(4,"xiaofang", 70);
        students[4] = new Student(5,"jiaofang", 70);
        students[5] = new Student(6, "a", 86);

        for (Student student: students) {
            System.out.println("Student before: " + student.toString());
        }
        // 就要按分数从低到高
